...
{
    public interface IGetLanguageAndLanguageKeyValueEqualAllService
    {
        ResultDto<List<ResultLanguageAndLanguageKeyValueEqualDto>> GetLanguageAndLanguageKeyValueEqualAll();
    }
}
